...
<body>
    <div class="d-flex">
        ...
        <div class="main-content flex-grow-1 p-4">
            ...
            <div class="line"></div>
            <h2 class="fw-100 text-primary mt-3">Assigned Treasurer Per Organization</h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($organizations as $org)
                                @php
                                    $admin = $admins->firstWhere('username', $org);
                                @endphp
                                <tr>
                                    <th scope="row">{{ $org }}</th>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editButtons.forEach(button => {
                button.addEventListener('click', () => {
                    ...
                    document.getElementById('edit-username').value = org;

                    // Set the form action dynamically
                    // editForm.action = `/usermanagement/${id}`; // adjust if route is named differently
                });
            });
        });
    </script>
